...
config.RPN_ANCHOR_CFG = {
    '32': {'SCALES': (32, 16), 'BASE_SIZE': 16, 'RATIOS': (1,), 'NUM_ANCHORS': 2, 'ALLOWED_BORDER': 9999},
    '16': {'SCALES': (8, 4), 'BASE_SIZE': 16, 'RATIOS': (1,), 'NUM_ANCHORS': 2, 'ALLOWED_BORDER': 9999},
    '8': {'SCALES': (2, 1), 'BASE_SIZE': 16, 'RATIOS': (1,), 'NUM_ANCHORS': 2, 'ALLOWED_BORDER': 9999},
}

config.LANDMARKS = False
...
dataset.ibugface = edict()
dataset.ibugface.dataset = 'ibugface'
dataset.ibugface.image_set = 'train'
dataset.ibugface.test_image_set = 'val'
dataset.ibugface.root_path = 'data'
dataset.ibugface.dataset_path = 'data/ibugface'
dataset.ibugface.NUM_CLASSES = 2
dataset.ibugface.LANDMARKS = False
...
default.dataset_path = 'data/widerface'
# default training
default.frequent = 20
...
#default.e2e_lr_step = '40,50,58'
#default.e2e_lr_step = '1,2'
# default rpn
